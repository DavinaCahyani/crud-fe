...
function Sidebar({ page }) {
  ...
  return (
    ...
    //     aria-label="Sidebar"
    //   >
    //     <header class="px-3 py-4 bg-gray-800 dark:bg-gray-900">
    //       <h1 class="text-white text-xl font-semibold">Data Sekolah</h1>
    //     </header>
    ...
    //   </aside>
    // </div>
    <div className="sidebar max-h-screen min-h-screen bg-[#1e1e1e] min-w-[20%] text-white flex flex-col w-[270px]">
      <div className="header text-3xl font-bold mx-4 mt-4">Data Sekolah</div>
      <hr className="mt-3" />
